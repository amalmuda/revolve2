...
PARAMS = sys.argv[2] if len(sys.argv) > 2 else "/tmp/fox_spider_n_l0_r1.npy"
COUPLING = sys.argv[3] if len(sys.argv) > 3 else "neighbor"
...
print(f"Opening viewer: {ROBOT.upper()} with ODE-CPG ({COUPLING}) brain")
