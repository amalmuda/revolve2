"""Render hexapod lying flat with no brain activity."""
import numpy as np
...
body = modular_robots_v1.get("hexapod")
...
# Zero weights = no movement, robot just lays there
...
print("Opening viewer: HEXAPOD (flat, no movement)")
print("Hinges: %d, Params: %d" % (n_hinges, n_params))
