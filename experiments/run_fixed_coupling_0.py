"""
Evolution for coupled sine brain with FIXED coupling=0 (no coupling).

This is for comparison: what happens when coupling is disabled?
Effectively the same as uncoupled sine but using the coupled sine brain.
...
Coupling is FIXED at 0 (not evolved).
"""
...
def evaluate_fixed_coupling_params(
    ...
    """
    Evaluate coupled sine parameters with FIXED coupling=0.
    ...
    try:
        ...
        brain = BrainCoupledSine.from_parameters(
            ...
            sine_params,
            frequency=frequency,
            coupling_strength=COUPLING_STRENGTH,  # FIXED at 0
        )
...
def main():
    """Run 250 generation evolution for coupled sine with FIXED coupling=0."""
    print("\n" + "=" * 70)
