"""Render queen body offscreen and save as PNG."""
import mujoco
import numpy as np
...
body = modular_robots_v1.get("queen")
...
img = renderer.render()
Image.fromarray(img).save("/tmp/queen_top.png")
print("saved /tmp/queen_top.png")

cam.elevation = -25
cam.azimuth = 135
renderer.update_scene(data, camera=cam)
Image.fromarray(renderer.render()).save("/tmp/queen_iso.png")
print("saved /tmp/queen_iso.png")
