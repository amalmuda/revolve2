"""View an evolved Kuramoto robot."""
import math
import sys
import numpy as np
...
PARAMS = sys.argv[2] if len(sys.argv) > 2 else "kuramoto_spider_blf_lam0_1p00hz_best.npy"
...
ks = kuramoto_structure_from_cpg_structure(cpg)
...
print(f"Opening: {ROBOT.upper()} Kuramoto {COUPLING} | omega={HZ} Hz")
