#!/bin/bash
#SBATCH --job-name=arachnid_bounds1_pop25
#SBATCH --account=ec29
#SBATCH --time=4:00:00
#SBATCH --nodes=1
...
# ============================================
# ARACHNID BOUNDS [-1,1] EXPERIMENT - POPULATION 25
# fitness = distance * (1 - contact)^λ
# 30s simulation, no warmup
# 1 bounds x 21 lambdas x 25 seeds = 525 jobs
# ============================================

# EXPERIMENT FOLDER NAME - change this for each new experiment batch!
# v2: Fixed feet detection (leaf body approach)
RESULTS_DIR="results/arachnid_v2_bounds1_pop25_25seeds"
...
echo "=========================================="
echo "ARACHNID BOUNDS [-1,1] EXPERIMENT - POPULATION 25"
echo "fitness = distance * (1 - contact)^λ"
