...
# Pilot: Revolve2's BrainCpgNetworkStatic with BLF coupling — rugged terrain.
...
# Copy back: the experiment subdir name is auto-generated by the python script.
