...
# ============================================
# BOUNDS [-1,1] EXPERIMENT - POPULATION 25
...
RESULTS_DIR="results/spider_v2_bounds1_pop25_25seeds"
...
echo "=========================================="
echo "BOUNDS [-1,1] EXPERIMENT - POPULATION 25"
