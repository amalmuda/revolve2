#!/bin/bash
#SBATCH --job-name=gecko_bounds1_pop25
#SBATCH --account=ec29
#SBATCH --time=4:00:00
#SBATCH --nodes=1
...
# ============================================
# GECKO BOUNDS [-1,1] EXPERIMENT - POPULATION 25
...
RESULTS_DIR="results/gecko_v2_bounds1_pop25_25seeds"
...
echo "=========================================="
echo "GECKO BOUNDS [-1,1] EXPERIMENT - POPULATION 25"
