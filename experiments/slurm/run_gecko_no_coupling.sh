...
# ============================================
# GECKO NO-COUPLING EXPERIMENT
# CPG with internal weights only (6 params)
...
RESULTS_DIR="results/gecko_no_coupling"
...
echo "=========================================="
echo "GECKO NO-COUPLING EXPERIMENT"
echo "CPG with internal weights only (6 params)"
...
echo "NO COUPLING: True (6 params)"
echo ""
