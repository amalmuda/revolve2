...
# Spider Bonardi 0.5 Hz, NO offset X evolved (X fixed at 0):
# 6 conditions x 2 lambdas x 5 seeds = 60
...
EXPERIMENT_NAME="${ROBOT}_bonardi_${VARIANT}_noX_${COUPLING}_lambda${LAMBDA}_nu${NU}_w${W}"
LOG_DIR="slurm/logs/spider_bonardi_noX_05hz/${EXPERIMENT_NAME}"
mkdir -p "$LOG_DIR"
