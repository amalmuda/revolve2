...
# ============================================
# QUEEN x BLF x LAMBDA 2 x 5 RUNS
# ============================================
...
RESULTS_DIR="results/queen_blf_l2"
...
LOG_DIR="slurm/logs/queen_blf_l2/${EXPERIMENT_NAME}"
mkdir -p "$LOG_DIR"

exec > "${LOG_DIR}/run_${RUN_NUM}.log" 2>&1

echo "=========================================="
echo "QUEEN BLF LAMBDA 2 - Run $RUN_NUM / 5"
echo "=========================================="
echo "  Robot:       $ROBOT"
