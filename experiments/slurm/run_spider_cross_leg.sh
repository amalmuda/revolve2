#!/bin/bash
#SBATCH --job-name=spider_cross_leg
#SBATCH --account=ec29
#SBATCH --time=2:00:00
#SBATCH --nodes=1
...
# ============================================
# SPIDER CROSS-LEG COUPLING EXPERIMENT
# CPG with neighbor + shoulder-to-shoulder connections (18 params)
# Cross-leg coupling between all shoulder hinges
...
RESULTS_DIR="results/spider_cross_leg"
...
EXPERIMENT_NAME="${ROBOT}_cross_leg_${FITNESS_FORMULA}_bounds${B_MAX}_lambda${LAMBDA//./_}"
...
echo "=========================================="
echo "SPIDER CROSS-LEG COUPLING EXPERIMENT"
echo "CPG with neighbor + shoulder-to-shoulder (18 params)"
echo "Cross-leg coupling between all shoulder hinges"
...
echo "CROSS-LEG COUPLING: True (18 params)"
echo ""
