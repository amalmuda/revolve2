...
# 500-gen rerun, 2 conditions x 2 lambdas x 5 seeds = 20
# Conditions: 0=phi_uncoupled, 1=base_blf
...
POPULATION=30
WORKERS=30
RESULTS_DIR="results/insect_bonardi_500gen_nu0.5_w1"
...
LOG_DIR="slurm/logs/insect_bonardi_500gen_05hz/${EXPERIMENT_NAME}"
mkdir -p "$LOG_DIR"
exec > "${LOG_DIR}/run_${RUN_NUM}.log" 2>&1

echo "$EXPERIMENT_NAME run $RUN_NUM seed $SEED gens=$GENERATIONS"
