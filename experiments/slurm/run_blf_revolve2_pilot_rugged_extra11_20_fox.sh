...
# Pilot extension: revolve2 BLF, runs 11-20 (10 extra seeds per cell), rugged terrain.
...
LOG_DIR="slurm/logs/revolve2_blf_pilot_rugged/${ROBOT}_${FITNESS}"
mkdir -p "$LOG_DIR"
