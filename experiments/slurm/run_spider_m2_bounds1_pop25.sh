#!/bin/bash
#SBATCH --job-name=spider_m2_bounds1_pop25
#SBATCH --account=ec29
#SBATCH --time=4:00:00
#SBATCH --nodes=1
...
# ============================================
# SPIDER M2 (BODY + FOOT SLIP) EXPERIMENT
# fitness = distance * (1 - contact_m2)^λ
# M2 = body contact OR foot slip (threshold=0.1 m/s)
# 30s simulation, no warmup
# 1 bounds x 21 lambdas x 25 seeds = 525 jobs
# ============================================

# EXPERIMENT FOLDER NAME
RESULTS_DIR="results/spider_m2_bounds1_pop25_25seeds"
...
echo "=========================================="
echo "SPIDER M2 (BODY + FOOT SLIP) EXPERIMENT"
echo "fitness = distance * (1 - contact_m2)^λ"
echo "M2 = body contact OR foot slip"
