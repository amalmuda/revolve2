#!/bin/bash
#SBATCH --job-name=gecko_cross_leg
#SBATCH --account=ec29
#SBATCH --time=2:00:00
#SBATCH --nodes=1
...
# ============================================
# GECKO CROSS-LEG COUPLING EXPERIMENT
# CPG with neighbor + shoulder-to-shoulder connections (12 params)
...
RESULTS_DIR="results/gecko_cross_leg"
...
echo "=========================================="
echo "GECKO CROSS-LEG COUPLING EXPERIMENT"
echo "CPG with neighbor + shoulder-to-shoulder (12 params)"
...
echo "CROSS-LEG COUPLING: True (12 params)"
echo ""
