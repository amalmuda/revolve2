#!/bin/bash
#SBATCH --job-name=zappa_uncoupled_l2
#SBATCH --account=ec29
#SBATCH --time=4:00:00
#SBATCH --nodes=1
...
# ============================================
# ZAPPA x UNCOUPLED x LAMBDA 2 x 5 RUNS
# ============================================
...
RESULTS_DIR="results/zappa_uncoupled_l2"
...
LOG_DIR="slurm/logs/zappa_uncoupled_l2/${EXPERIMENT_NAME}"
mkdir -p "$LOG_DIR"

exec > "${LOG_DIR}/run_${RUN_NUM}.log" 2>&1

echo "=========================================="
echo "ZAPPA UNCOUPLED LAMBDA 2 - Run $RUN_NUM / 5"
echo "=========================================="
echo "  Robot:       $ROBOT"
