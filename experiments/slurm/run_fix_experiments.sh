...
#
# Job breakdown:
#   3 robots × 3 couplings × 4 lambdas × 10 seeds = 360
#
# Layout:
#   Jobs 1-120:   gecko        (3 couplings × 4 lambdas × 10 seeds)
#   Jobs 121-240: spider       (3 couplings × 4 lambdas × 10 seeds)
#   Jobs 241-360: gecko_spider (3 couplings × 4 lambdas × 10 seeds)
#
# Settings:
#   - Simulation time: 30s
#   - Generations: 300
