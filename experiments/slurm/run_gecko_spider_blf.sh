...
# ============================================
# GECKO_SPIDER BLF COUPLING EXPERIMENTS
# ============================================
# ODE CPG with BLF coupling on gecko_spider
#
# Comparing:
#   - Controllers: ode_cpg (1)
#   - Coupling: blf (1)
#   - Penalty: lambda=0, 1 (2)
#   - Seeds: 10 per configuration
#
# Job breakdown:
#   Jobs 1-10:   ode_cpg blf lambda=0 (10 seeds)
#   Jobs 11-20:  ode_cpg blf lambda=1 (10 seeds)
#
# Total: 1 × 1 × 2 × 10 = 20 jobs
#
# Settings:
#   - Simulation time: 30s
#   - Generations: 300
...
echo "=========================================="
echo "GECKO_SPIDER BLF EXPERIMENT"
echo "=========================================="
echo "Task ID: $TASK_ID / 20"
echo ""
echo "Configuration:"
echo "  Robot:       $ROBOT"
